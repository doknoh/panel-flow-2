...
export default function ZenMode({
  ...
  const saveField = useCallback(async (
    ...
    // When saving visual_description, also update characters_present
    const updateData: Record<string, unknown> = { [field]: value }
    if (table === 'panels' && field === 'visual_description') {
      updateData.characters_present = scanCharactersPresent(value || '', characters)
    }
