  ...
  return (
    <div className="bg-[var(--color-primary)]/10 border border-[var(--color-primary)]/20 rounded px-4 py-2 mx-5 flex items-center justify-between">
      ...
      <div className="flex items-center gap-3">
        <select
          className="bg-transparent border border-[var(--border)] rounded px-2 py-1 text-[8px] font-bold tracking-wider uppercase cursor-pointer font-mono"
          value=""
          onChange={(e) => {
            if (e.target.value) {
        ...
        <button
          ...
          className="font-mono text-[8px] font-bold tracking-wider text-[var(--color-error)] hover:opacity-80 cursor-pointer"
        >
          DESELECT ALL
        </button>
      </div>
